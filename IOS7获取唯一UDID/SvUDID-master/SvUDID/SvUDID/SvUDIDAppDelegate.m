...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[[SvUDIDViewController alloc] initWithNibName:@"SvUDIDViewController_iPhone" bundle:nil] autorelease];
    } else {
        self.viewController = [[[SvUDIDViewController alloc] initWithNibName:@"SvUDIDViewController_iPad" bundle:nil] autorelease];
    }
